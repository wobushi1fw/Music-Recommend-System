package com.example.musicrecommendationsys.common;
...
// ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/musicrecommend?useUnicode=true&characterEncoding=utf-8&useSSL=false&allowPublicKeyRetrieval=true");
...
// ⼆、模块配置
        pc.setParent("com.example.musicrecommendationsys")
                .setEntity("entity")
                .setMapper("mapper")
                .setService("service")
